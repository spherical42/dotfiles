...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "b", function() awful.spawn("flatpak run io.github.zen_browser.zen") end,
        { description = "open a browser", group = "launcher" }),
    awful.key({ modkey, }, "e", function() awful.spawn("nautilus") end,
        { description = "open files", group = "launcher" }),
    awful.key({ modkey, }, "v", function() awful.spawn("/home/james/.local/bin/zed") end,
        { description = "open zed", group = "launcher" }),
    awful.key({ modkey, }, "g", function() awful.spawn.with_shell("gd") end,
        { description = "open godot", group = "launcher" }),
    awful.key({ modkey, }, "o", function() awful.spawn.with_shell("obsidian") end,
